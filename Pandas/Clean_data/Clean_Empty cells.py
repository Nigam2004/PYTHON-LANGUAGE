...
df1=pd.read_csv("Pandas/Clean_data/domy.csv")
print(df1)
new_df=df1.dropna()  
...
df2=pd.read_csv("Pandas/Clean_data/domy.csv")
...
df3=pd.read_csv("Pandas/Clean_data/domy.csv")
...
df4=pd.read_csv("Pandas/Clean_data/domy.csv")
...
df5=pd.read_csv("Pandas/Clean_data/domy.csv")
